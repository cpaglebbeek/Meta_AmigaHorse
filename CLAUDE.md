...
| AmigaHorse_Web | v0.0.4 | Speedball 2 |
| AmigaHorse_Web | v0.0.5 | R-Type |
...
| AmigaHorse_Web | v0.0.10 | Hunter |
| AmigaHorse_Web | v0.0.11 | Alien Breed |
| AmigaHorse_Web | v0.0.12 | Project-X |
| AmigaHorse_Web | v0.0.13 | Super Frog |
| AmigaHorse_Web | v0.0.14 | IK+ |
...
### Vrije pool (Amiga-game-legendes, willekeurige volgorde)
 ...
 Syndicate, Magic Pockets, Lionheart, Banshee, Body Blows, Brutal Sports Football, F/A-18 Interceptor, Killing Game Show, Mega-lo-Mania, Microprose Soccer, Monkey Island, Beneath a Steel Sky, Settlers, Theme Park, Theme Hospital, UFO Enemy Unknown, Wing Commander, Zool, Walker, Agony, Disposable Hero.
